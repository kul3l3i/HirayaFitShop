...
<body>
    ...
    <nav class="main-nav" id="mainNav">
        ...
        <a href="acces.php" class="active">ACCESSORIES</a>
...
<section class="page-header">
    <img src="images/banner.jpg" alt="Accessories Collection Header Image">
    <div class="header-overlay"></div>
    <div class="container header-content">
        <h1>ACCESSORIES</h1>
        <p>ESSENTIAL GEAR TO ENHANCE YOUR PERFORMANCE</p>
    </div>
</section>
    <!-- Breadcrumbs -->
