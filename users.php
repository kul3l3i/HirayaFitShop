...
<head>
    ...
    <title>User Management - HirayaFit Admin</title>    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" rel="stylesheet">
    <!-- jsPDF Libraries -->
    ...
    <style>
        ...
        * {
        ...
        .sidebar-menu a.active {
            background-color: rgba(0, 113, 197, 0.15);
            border-left-color: var(--secondary);
            color: var(--secondary);
        }
...
<body>
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="user-management.php" class="active"><i class="fas fa-users"></i> User Management</a>
