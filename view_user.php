...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['toggle_status'])) {
    ...
    if (setUserActiveStatus($userId, $newStatus)) {
        ...
        $user['is_active'] = $newStatus; // Update user status in current view
    }
}
?>
...
<head>
    ...
    <title>User Details - HirayaFit Admin</title>
    <!-- Bootstrap CSS -->
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="profile-header d-flex flex-column flex-md-row align-items-center mb-4">
                                <div class="text-center me-md-4 mb-3 mb-md-0">
                                    <?php if (!empty($user['profile_image']) && file_exists('uploads/profiles/' . $user['profile_image'])): ?>
                                        <img src="uploads/profiles/<?php echo $user['profile_image']; ?>" alt="Profile" class="profile-image">
                                    <?php else: ?>
                                        <img src="assets/images/default-avatar.png" alt="Default Profile" class="profile-image">
                                    <?php endif; ?>
                                </div>
                                <div>
                                    ...
                                    <div class="mt-3">
                                        <button type="button" class="btn btn-sm btn-warning me-2" data-bs-toggle="modal" data-bs-target="#toggleStatusModal">
                                            <i class="fas <?php echo $user['is_active'] ? 'fa-ban' : 'fa-check'; ?> me-1"></i>
                            ...
                            <div class="row user-details p-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="detail-item">
                                        ...
                                        <span class="ms-2"><?php echo !empty($user['phone']) ? htmlspecialchars($user['phone']) : 'Not provided'; ?></span>
                                    </div>
                                    <div class="detail-item">
                                        <strong><i class="fas fa-map-marker-alt me-2"></i>Address:</strong>
                                        <span class="ms-2"><?php echo !empty($user['address']) ? htmlspecialchars($user['address']) : 'Not provided'; ?></span>
                                    </div>
                                    <div class="detail-item">
                                        <strong><i class="fas fa-clock me-2"></i>Last Login:</strong>
                                        <span class="ms-2"><?php echo formatDateTime($user['last_login']); ?></span>
                                    </div>
                                    <div class="detail-item">
                                        <strong><i class="fas fa-calendar-alt me-2"></i>Registered:</strong>
                                        <span class="ms-2"><?php echo formatDateTime($user['created_at']); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <form method="POST" action="">
                <div class="modal-body">
                    <div class="alert alert-warning">
                        ...
                        Are you sure you want to delete user: <strong><?php echo htmlspecialchars($user['fullname']); ?></strong>?
