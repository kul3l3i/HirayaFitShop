...
<head>
    ...
    <style>
        ...
        * {
        ...
        .hero {
            background: linear-gradient(rgba(0,0,0,0.2), rgba(0,0,0,0.2)), url("/api/placeholder/1600/500") no-repeat center center;
...
<body>
    ...
    <nav class="main-nav" id="mainNav">
        ...
        <a href="foot.php" class="active">FOOTWEAR</a>
...
<section class="page-header">
    <img src="images/banner.jpg" alt="Footwear Collection Header Image">
    <div class="header-overlay"></div>
    <div class="container header-content">
        <h1>FOOTWEAR</h1>
        <p>ENGINEERED SUPPORT FOR EVERY ATHLETIC PURSUIT</p>
    </div>
</section>
    <!-- Breadcrumbs -->
