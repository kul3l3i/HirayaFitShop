...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $recaptcha_secret = "6Lf4Lh0rAAAAAKNyrG0BClwKvZpmVVjld6fI9dzb"; // Replace with your secret key
...
<head>
    ...
    <title>Sign Up - HirayaFit</title>    <link rel="icon" href="images/logo.png">
    ...
    <section>
        ...
        <div class="signup-container">
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
                ...
                <!-- reCAPTCHA -->
                <div class="g-recaptcha" data-sitekey="6Lf4Lh0rAAAAAJXRKB6ghJUQHcutfnFI6KYFSq7l"></div>
